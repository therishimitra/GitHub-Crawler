        ...
        try:
            for tr in table_rows:
                ...
                if row[1].startswith('def '):
                    ...
                    for dependant,dependant_location in zip(dep,dep_loc):
                        updateCSV(r'C:\Users\rishi\PycharmProjects\numpy_crawler\venv\GH_Database2.csv',[name_str, loc_str, desc_str, param_str, ret_str,dependant,dependant_location])
